...
public class MoneyUSReader implements IMoneyReader {
    ...
    public String convert(String value) {
        try {
            ...
            if (list.length == 1) {
                ...
                return processor.getName(list[0]) + " " + getTextCcy(first <= 1);
            } else if (list.length == 2) {
                int first = Integer.parseInt(list[0]);
                int second = Integer.parseInt(list[1]);
                if (second <= 0) {
                    return processor.getName(list[0]) + " " + getTextCcy(first <= 1);
                } else if (list[1].length() <= 1 && second < 10) {
                    return processor.getName(list[0]) + " " + getTextCcy(first <= 1) + " and " + processor.getName(list[1] + "0").toLowerCase() + " " + getSubTextCcy(Integer.parseInt(list[1] + "0") <= 1);
                } else {
                    return processor.getName(list[0]) + " " + getTextCcy(first <= 1) + " and " + processor.getName(list[1]).toLowerCase() + " " + getSubTextCcy(false);
                }
            } else {
                return null;
            }
    ...
    public void setCcy(String ccy) {
        this.ccy = ccy.trim().toUpperCase();
    }

    private String getTextCcy(boolean single) {
        if ("usd".equalsIgnoreCase(ccy)) {
            return single ? "dollar" : "dollars";
        } else if ("eur".equalsIgnoreCase(ccy)) {
            return single ? "euro" : "euros";
        } else if ("aud".equalsIgnoreCase(ccy)) {
            return single ? "Australian dollar" : "Australian dollars";
        } else if ("nzd".equalsIgnoreCase(ccy)) {
            return single ? "New Zealand dollar" : "New Zealand dollars";
        } else if ("hkd".equalsIgnoreCase(ccy)) {
            return single ? "Hong Kong dollar" : "Hong Kong dollars";
        } else if ("sgd".equalsIgnoreCase(ccy)) {
            return single ? "Singapore dollar" : "Singapore dollars";
        } else if ("rub".equalsIgnoreCase(ccy)) {
            return single ? "Russian ruble" : "Russian rubles";
        } else if ("sek".equalsIgnoreCase(ccy)) {
            return single ? "Swedish krona" : "Swedish kronas";
        } else if ("gbp".equalsIgnoreCase(ccy)) {
            return single ? "British pound" : "British pounds";
        } else if ("thb".equalsIgnoreCase(ccy)) {
            return single ? "Thai baht" : "Thai bahts";
        } else if ("dkk".equalsIgnoreCase(ccy)) {
            return single ? "Danish krone" : "Danish krones";
        } else if ("jpy".equalsIgnoreCase(ccy)) {
            return single ? "yens" : "yens";
        } else if ("chf".equalsIgnoreCase(ccy)) {
            return single ? "Swiss franc" : "Swiss francs";
        } else if ("nok".equalsIgnoreCase(ccy)) {
            return single ? "Norwegian krone" : "Norwegian krones";
        } else
            return "dong";
    }

    private String getSubTextCcy(boolean single) {
        if ("usd".equalsIgnoreCase(ccy)
                || "eur".equalsIgnoreCase(ccy)
                || "aud".equalsIgnoreCase(ccy)
                || "nzd".equalsIgnoreCase(ccy)
                || "hkd".equalsIgnoreCase(ccy)
                || "sgd".equalsIgnoreCase(ccy)
        ) {
            return single ? "cent" : "cents";
        } else if ("gbp".equalsIgnoreCase(ccy)) {
            return single ? "penny" : "pennys";
        } else if ("sek".equalsIgnoreCase(ccy)) {
            return "ores";
        } else if ("rub".equalsIgnoreCase(ccy)) {
            return "kopeks";
    ...
    public class DefaultProcessor extends AbstractProcessor {
        ...
        public String getName(String value) {
            ...
            return UtilsBase.g().Captain(name);
        }
    }
}
